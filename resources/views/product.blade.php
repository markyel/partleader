        ...
        <div class="p-5 text-start bg-body-tertiary">
            <div class="container py-5">
                ...
                <p class="col-lg-8 mx-auto lead">
                    ...
                    ПартЛидер может предложить запчасти практически для любых лифтов и эскалаторов От Вас больше ничего не требуется. Все остальные действия сделает ПартЛидер.
                </p>
                <p class="col-lg-8 mx-auto lead">
